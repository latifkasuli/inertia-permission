...
<template>
    ...
    <AdminLayout>
        ...
        <div
            class="max-w-6xl mx-auto mt-6 px-6 py-4 bg-white dark:bg-gray-800 shadow-md sm:rounded-lg"
        >
        ...
        >
            <h1 class="text-2xl p-4 dark:text-gray-400">User Roles</h1>
            <Table>
                <template #tablehead>
                    <TableRow>
                ...
                <template #default>
                    <TableRow
                        ...
                        class="border-b"
                    >
                        <table-data-cell>{{ userRole.id }}</table-data-cell>
                        <table-data-cell>{{ userRole.name }}</table-data-cell>
        ...
        <div
            class="mt-6 max-w-6xl mx-auto w-full sm:max-w-5xl px-6 py-4 bg-white dark:bg-gray-800 shadow-md sm:rounded-lg"
        >
            <h1 class="text-2xl p-4 dark:text-gray-400">User Permissions</h1>
            <Table>
                <template #tablehead>
                    <TableRow>
                        <table-header-cell>#</table-header-cell>
