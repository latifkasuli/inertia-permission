...
<template>
    <div class="w-full h-full">
        <aside
            ...
            <div>
                ...
                <ul class="space-y-2 tracking-wide mt-8">
                    <li>
                        <sidebar-link :href="route('dashboard')" aria-label="dashboard"
                    ...
                    <li>
                        <sidebar-link :href="route('users.index')" :active="route().current('users.index')">
                    ...
                    <li>
                        <sidebar-link :href="route('roles.index')" :active="route().current('roles.index')">
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
                                stroke="currentColor" class="w-6 h-6">
                                <path stroke-linecap="round" stroke-linejoin="round"
                    ...
                    <li>
                        <sidebar-link :href="route('permissions.index')" :active="route().current('permissions.index')">
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
                                stroke="currentColor" class="w-6 h-6">
                                <path stroke-linecap="round" stroke-linejoin="round"
        ...
        <div class="ml-auto mb-6 lg:w-[75%] xl:w-[80%] 2xl:w-[85%]">
            <div class="sticky z-10 top-0 h-16 border-b bg-white lg:py-2.5 dark:bg-gray-900">
